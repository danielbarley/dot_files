...
_G.packer_plugins = {
  ...
  ["FTerm.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/FTerm.nvim",
  ...
  ["asyncrun.vim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/asyncrun.vim",
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/cmp-calc",
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/popup.nvim",
    url = "https://github.com/nvim-lua/popup.nvim"
  },
  ["surround.nvim"] = {
    config = { "\27LJ\2\nU\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\19mappings_style\rsandwich\nsetup\rsurround\frequire\0" },
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/surround.nvim",
    url = "https://github.com/ur4ltz/surround.nvim"
  },
  ["tabline.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/tabline.nvim",
