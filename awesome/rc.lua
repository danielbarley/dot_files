...
run_once({ "unclutter -root", "compton -C" }) -- entries must be comma-separated
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "shift"   }, "x", function() os.execute("i3lock -i ~/Wallpapers/lockscreen.png") end,
    ...
    awful.key({ modkey,           }, "w", function () awful.spawn("rofi -show window") end,
              {description = "rofi change window", group = "client"}),
